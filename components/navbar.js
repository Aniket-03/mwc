...
const Navbar = () => {
  ...
  return (
    <Stack className="relative z-10">
      ...
      >
        ...
        <div className="flex space-x-6 mb-2 sm:mb-0">
            <div className="flex items-center">
              ...
              <span className="text-md text-gray-100">+1 (123) 456-7890</span>
            </div>
            <div className="flex items-center">
              <svg className="w-4 h-4 text-gray-100 mr-2" fill="none" stroke="#ff4d00" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <span className="text-md text-gray-100">info@mwcconnect.com</span>
            </div>
            <div className="flex items-center">
              <svg className="w-4 h-4 text-gray-100 mr-2" fill="none" stroke="#ff4d00" viewBox="0 0 24 24">
              ...
              <span className="text-md text-gray-100">123 Main Street, City, State</span>
            </div>
          </div>
          
          {/* Login Button - Styled like the Book Appointment Button */}
          <a href="#" className="bg-[#003366] ml-8 text-xl text-white px-8 py-2 flex items-center font-medium transition hover:bg-blue-800 whitespace-nowrap">
            Login
      ...
      {/* responsive drawer */}
      <Hidden lgUp>
        <Drawer className="text-xl" anchor="right" open={open} onClose={handleDrawerClose}>
